          ...
          <div className='grid md:grid-cols-1 grid-cols-2  md:w-[100%] md-lg:w-[80%] w-[60%] mx-auto bg-white rounded-md'>
            <div className='px-8 py-8'>
              ...
              <div className=''>
                ...
                <button className='px-8 w-full py-2 bg-blue-500 shadow-md hover:shadow-md hover:bg-blue-600 hover:shadow-blue-500/50 text-white rounded-md flex justify-center items-center gap-2 mb-3 duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-700  focus:ring-opacity-50'>
                  <span className=''>
                    <FaFacebook />
                  </span>
                  <span className=''>Register with Facebook</span>
                </button>
                <button className='px-8 w-full py-2 bg-[#BB001B] shadow-md hover:shadow-md hover:bg-[#8c0318] hover:shadow-[#BB001B]/50 text-white rounded-md flex justify-center items-center gap-2 mb-3 duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-[#971b2d] focus:ring-opacity-50'>
                  <span className=''>
                    <FaGoogle />
                  </span>
